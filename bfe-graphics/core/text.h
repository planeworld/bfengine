...
class CText : virtual public CGraphicsBase
{
    ...
    public:
        ...
        CText() = delete;
        CText(bfe::CFontManager* const _pFontManager);
        ...
        void setFontManager(bfe::CFontManager* _pFontManager) {m_pFontManager = _pFontManager;}
    ...
    private:
        ...
        bfe::CFontManager*   m_pFontManager; ///< Font manager to use for drawing
};
